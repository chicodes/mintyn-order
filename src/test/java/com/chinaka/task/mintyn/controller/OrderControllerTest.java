...
import com.chinaka.task.mintyn.MintynTaskApplication;
...
class ProducerApplicationTests {
    ...
    void addOrderShouldBeSuccessful() throws Exception {
        ...
        orderDto.setTransactionType(ProductStatus.SALE.name());
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/order/")
                ...
                .andExpect(jsonPath("$.respBody.transactionType", Matchers.is(ProductStatus.SALE.name())));
    }
    ...
    void editOrderShouldBeSuccessful() throws Exception {
       ...
       MvcResult result =  mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/order/")
        ...
        orderDto1.setTransactionType(ProductStatus.SALE.name());
