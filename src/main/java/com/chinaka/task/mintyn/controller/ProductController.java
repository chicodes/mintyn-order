...
import com.chinaka.task.mintyn.service.ProductService;
...
public class ProductController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<GenericResponse> patchProduct(@PathVariable String id, @RequestBody ProductDto request) {
